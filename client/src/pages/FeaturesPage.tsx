...
export default function FeaturesPage() {
  ...
  return (
    <div className="bg-neutral-50 min-h-screen">
      ...
      {/* Testimonials */}
      <section className="relative py-20 overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-tr from-pink-50 via-white to-purple-50 z-0 animate-gradient-flow"></div>
        <div className="relative container mx-auto px-6 text-center">
          <h2 className="text-3xl sm:text-4xl font-extrabold bg-gradient-to-r from-primary to-secondary text-transparent bg-clip-text mb-12">
          ...
          >
            {testimonials.map((t, i) => (
              <motion.div
                ...
                className="glass-card p-8 rounded-2xl border-l-4 border-primary text-left shadow hover:shadow-md"
              >
      ...
      <section className="relative py-20 bg-gradient-to-r from-blue-400 via-indigo-400 to-purple-500 text-white overflow-hidden">
        ...
        <div className="relative container mx-auto px-6 flex flex-wrap justify-center gap-12 text-center">
          {[
            { label: 'Mentors', end: 300, suffix: '+' },
            { label: 'Students Helped', end: 2000, suffix: '+' },
