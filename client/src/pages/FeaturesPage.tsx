...
const features = [
  {
    ...
    description:
      "Organize your applications with a drag-and-drop kanban board. Easily track each application's status, from 'Interested' to 'Submitted' and beyond. Visualize your progress at a glance.",
    icon: "📊",
    image:
      "https://images.ctfassets.net/w6r2i5d8q73s/6wpAeUvjqESIFd6ayYpLcR/d19af2d0b32be76f1a8d64860e8fafbe/agile_kanban_product-image_EN_big_3_2.png",
  },
  {
    title: "Integrated Communication Hub",
    description:
      "Keep all your communication related to applications in one organized place. Log emails, notes from calls, and important contact information effortlessly.",
    icon: "✉️",
    image:
      "https://img.freepik.com/free-vector/illustration-business-people_53876-58974.jpg?semt=ais_hybrid&w=740&q=80",
  },
  {
    title: "Automated Program & Scholarship Discovery",
    description:
      "Discover relevant graduate programs and scholarship opportunities tailored to your profile and interests. Our smart algorithms do the heavy lifting for you.",
    icon: "⚙️",
    image:
      "https://d3bkbkx82g74b8.cloudfront.",
  },
  {
    title: "Comprehensive Notes & Deadline Management",
    description:
      "Attach detailed notes, upload documents, and set reminders for every application. Our system ensures you never miss a crucial deadline or forget important details.",
    icon: "📝",
    image:
      "https://www.shutterstock.com/image-photo/business-planning-calendar-agenda-work-600nw-2461973363.jpg",
  },
  {
    title: "Progress Visualization & Analytics",
    description:
      "Track your overall progress with insightful charts and analytics. Understand where you stand with your applications and identify areas needing attention.",
    icon: "📈",
    image:
      "https://pce.sandiego.edu/wp-content/uploads/2022/03/usd-pce-data-analytics-visualization.jpeg",
  },
  {
    title: "Secure Cloud Storage",
    description:
      "Your data and documents are securely stored in the cloud, accessible from any device, anytime. Focus on your applications, knowing your information is safe.",
    icon: "🔒",
    image:
      "https://assets.esecurityplanet.com/uploads/2024/01/esp_20240117-how-secure-is-cloud-storage.png",
  },
];
...
const testimonials = [
  ...
  {
    quote:
      "The automated program discovery feature helped me find a scholarship I never would have known about otherwise. Highly recommend!",
    name: "Jasmine T.",
    ...
    <div className="bg-neutral-50 min-h-screen">
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-6 text-center">
          <h2 className="text-3xl sm:text-4xl font-extrabold text-blue-900 mb-12">How It Works</h2>
          <motion.div initial="hidden" whileInView="show" viewport={{ once: true }} variants={container} className="grid grid-cols-1 md:grid-cols-4 gap-10">
            {howItWorksSteps.map((step, i) => (
              <motion.div
                key={i}
                variants={item}
                className="bg-neutral-50 p-6 rounded-xl shadow-md hover:shadow-lg transition"
              >
                <div className="mx-auto w-20 h-20 bg-primary/10 text-primary rounded-full flex items-center justify-center text-3xl font-bold mb-4">
                  {step.step}
                </div>
      ...
      <section className="py-16 bg-neutral-100">
        <div className="container mx-auto px-6 text-center">
          <h2 className="text-3xl sm:text-4xl font-extrabold text-blue-900 mb-12">Explore Our Powerful Features</h2>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-6 text-center">
          <h2 className="text-3xl sm:text-4xl font-extrabold text-blue-900 mb-12">What Our Users Are Saying</h2>
      ...
      {/* Kanban Dashboard Visual */}
      <section className="py-16 bg-neutral-50">
        <div className="container mx-auto px-6 text-center">
          <h2 className="text-3xl sm:text-4xl font-extrabold text-blue-900 mb-8">Visualize Your Progress</h2>
          <motion.img
            ...
            className="rounded-2xl shadow-xl mx-auto border border-neutral-200"
